...
function validacaoCadastro() {
  ...
  function validacaoCadastro() {
    ...
    if (admin == "") {
      classObj = document.getElementById("inputAdmin")
      classObj.classList.remove("inputAdmin")
      classObj.classList.add("inputError")
      alert("Insira seu seu código de administrador")
    } else {
      classObj = document.getElementById("inputAdmin")
      classObj.classList.remove("inputError")
      classObj.classList.add("inputAdmin")
    };
